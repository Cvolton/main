...
public class cvoltonSlab extends BlockSlab
{
public static final String[] woodType = { "blockMySlab" };

public cvoltonSlab(boolean isDouble, Material mat)
{
super(isDouble, mat);
...
{
return Item.getItemFromBlock(ModItems.cobbleSlab);
}

public void onBlockPlacedBy(World par1World, int par2, int par3, int par4, EntityLiving par5EntityLiving)
{
if(par1World.getBlock(par2, par3 - 1, par4) == ModItems.cobbleSlab)
{
par1World.setBlock(par2, par3 - 1, par4, ModItems.cobbleSlabDouble);
}
if(par1World.getBlock(par2, par3 + 1, par4) == ModItems.cobbleSlab)
{
par1World.setBlock(par2, par3 + 1, par4, ModItems.cobbleSlabDouble);
...
{
return new ItemStack(ModItems.cobbleSlab, 2, par1 & 7);
}
...
{
if (block != ModItems.cobbleSlabDouble)
{
